...
function NER_Corpus(data, BROWN, SentenceClass) {
   NER_Corpus.super_.call(this, data, BROWN, SentenceClass);
}

util.inherits(NER_Corpus, Corpus);

NER_Corpus.prototype.generateSample = function() {
...
NER_Corpus.prototype.splitInTrainAndTest = function(percentageTrain) {
  var corpusTrain = new NER_Corpus();
  var corpusTest = new NER_Corpus();
